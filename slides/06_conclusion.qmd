...
- to the SAIHST organizers, in particular Sang Ho Park, for making this event possible `r emoji::emoji("clap")`
...
-   Bookmark the [`openstatsguide`](https://www.openstatsware.org/guide.html) as a quick reference for good practices for R package development
