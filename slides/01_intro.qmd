...
삼성헬스케어과학기술원(SAIHST)에서 주최하는 R 패키지 활용 우수 소프트웨어 엔지니어링 실무 워크숍에 오신 것을 환영합니다! `r emoji("korea")`

I have enjoyed the 33rd International
Biometric Conference in Seoul and am looking forward to teaching today's workshop! `r emoji("smile")`

Big thanks to Sang Ho Park for the local organization `r emoji("folded_hands")`
...
-   Happy Taipei expat since summer 2024, where I started roadbiking `r emoji("biking")`
