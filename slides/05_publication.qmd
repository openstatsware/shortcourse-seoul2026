...
a. MIT license
b. Any license
c. No license because that assumes transfer of my rights from the original repo's MIT license
:::
...
- Enable GitHub page through `use_pkgdown_github_pages`
  - ([`use_pkgdown_github_pages`](https://pkgdown.r-lib.org/articles/pkgdown.html) includes: `use_pkgdown()`, `use_github_pages()`, `use_github_action("pkgdown")`)
