...
The event will be held on Friday, 17^th^ of July 2026, from 09:00 to 17:00 as an in-person workshop at the [Samsung Advanced Institute for Health Sciences & Technology (SAIHST), Sungkyunkwan University](https://www.saihst.kr/).
...
Please [register for the workshop](https://www.linkedin.com/feed/update/urn:li:activity:7475173238583521281/) in advance.
...
### Material for Questions from the Course

For Shiny: 

-   Shiny considerations: [slides](https://rconis.github.io/workshop-r-swe-zrh/slides/07_shiny.html)

For submission to health authorities etc:

-   Reproducibility considerations: [slides](https://rconis.github.io/workshop-r-swe-zrh/slides/10_reproducibility.html)
-   Considerations for R submissions in Japan: [PharmaSUG paper](https://pharmasug.org/proceedings/2025/PO/PharmaSUG-2025-PO-140.pdf)
-   Pilot 3 summary of R submissions working group: [PharmaSUG paper](https://phuse.s3.eu-central-1.amazonaws.com/Archive/2025/Connect/US/Orlando/PAP_PP17.pdf)
